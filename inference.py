...
class BERT_NER_inference(object):
    ...
    def predict(self, text_input):
        ...
        labels = [self.tag_values[label_idx] for label_idx in label_indices[0]]
...
print(inference.predict("Divy Murli went to university at UCSB and graduate school at Stanford, both of which are in California."))
